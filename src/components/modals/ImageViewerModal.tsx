...
export function ImageViewerModal({ isOpen, onClose, imageSrc, imageTitle, imageAlt }: ImageViewerModalProps) {
    ...
    const handleDownload = async () => {
        try {
            ...
            if (imageSrc.startsWith('data:')) {
                ...
                link.href = imageSrc;
                link.download = `${imageTitle || 'image'}_${new Date().toISOString().split('T')[0]}.png`;
        ...
        >
            ...
            >
                ...
                <p className="mt-3 text-center text-xs text-slate-400">
                    Press <kbd className="rounded bg-slate-200 px-1.5 py-0.5 font-mono">Esc</kbd> or click outside to close
                </p>
            </div>
        </div>
    );
